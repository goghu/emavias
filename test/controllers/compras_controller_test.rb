...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { docvalor: @compra.docvalor, fecha: @compra.fecha, numero: @compra.numero } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { docvalor: @compra.docvalor, fecha: @compra.fecha, numero: @compra.numero } }
