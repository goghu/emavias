...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { descripcion: @cargo.descripcion, nivel: @cargo.nivel } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { descripcion: @cargo.descripcion, nivel: @cargo.nivel } }
