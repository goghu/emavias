...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post documentos_url, params: { documento: { correlativo: @documento.correlativo, descripcion: @documento.descripcion, observaciones: @documento.observaciones, presento: @documento.presento } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { correlativo: @documento.correlativo, descripcion: @documento.descripcion, observaciones: @documento.observaciones, presento: @documento.presento } }
