...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { cite: @memo.cite, docderivacione_id: @memo.docderivacione_id, documento: @memo.documento, fecha: @memo.fecha } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { cite: @memo.cite, docderivacione_id: @memo.docderivacione_id, documento: @memo.documento, fecha: @memo.fecha } }
