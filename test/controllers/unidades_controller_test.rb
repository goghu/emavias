...
class UnidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unidade" do
    assert_difference('Unidade.count') do
      post unidades_url, params: { unidade: { descripcion: @unidade.descripcion, estado: @unidade.estado } }
    end
  ...
  test "should update unidade" do
    patch unidade_url(@unidade), params: { unidade: { descripcion: @unidade.descripcion, estado: @unidade.estado } }
