class Pedido2Datatable < AjaxDatatablesRails::Base
    ...
    def get_raw_records
      ...
      .joins("INNER JOIN totals ON (totals.producto_id = productos.id AND ISNULL(totals.deleted) AND totals.almacen_id = #{@idAlmacen} )")
