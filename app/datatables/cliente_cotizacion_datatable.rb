class ClienteCotizacionDatatable < AjaxDatatablesRails::Base
    ...
    def get_raw_records
      # insert query here
      Producto.select('productos.id','productos.codigo','productos.nombre','productos.precio','categoria.nombre as nombre_categoria')
